...
| the query builder class.
						*/
$active_group = ''; //$_SERVER['HTTP_HOST']; //'default';

$query_builder = TRUE;
$domain = $_SERVER['HTTP_HOST'];
$domain = preg_replace('/^www\./i', '', $domain);

// Initialize the active group variable
$active_group = '';

$db['default'] = array(
	'dsn'	=> '',
	'hostname' => 'localhost', //'premium265.web-hosting.com',
	'username' => 'trixschool_trixschooladmin',
	'password' => 'trixschool@1111',
...
$database_configs = array(
    ...
    'joyfoundationacademy.com.ng' => array(
        'dsn'	=> '',
    	'hostname' => 'premium265.web-hosting.com',
    	'username' => 'trixschool_kencrestadmin',
    	'password' => 'kencrest@1111',
...
$db[$active_group] = $database_configs[$active_group];
