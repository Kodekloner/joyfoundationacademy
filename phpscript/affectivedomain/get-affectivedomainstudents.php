            ...
            echo'<span id="displaysmg" style="font-size:14px;"><div class="alert alert-primary" role="alert">
              ...
              <table class="table table-striped table-bordered" id="editable-datatable" style="margin-top: 30px;">
                ...
                <tbody>';
                    ...
                    $sqlGetstudent_session = "SELECT * FROM `students` INNER JOIN affective_domain_score ON students.id=affective_domain_score.studentid AND affective_domain_score.session='$session' AND affective_domain_score.classid = '$classid' AND affective_domain_score.sectionid = '$sectionnew' AND affective_domain_score.term = '$term' AND students.is_active = 'yes'";
