...
include ('../../database/config.php');
    ...
    if($countGetclass_sections > 0){
        ...
        $sqlGetstudent_session = "SELECT * FROM `student_session` INNER JOIN students ON student_session.student_id=students.id WHERE session_id='$session' AND class_id = '$classid' AND section_id = '$sectionnew' AND students.is_active = 'yes'";
