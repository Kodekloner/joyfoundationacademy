            ...
            echo'<span id="displaysmg" style="font-size:14px;"><div class="alert alert-primary" role="alert">
              ...
              <table class="table table-striped table-bordered" id="editable-datatable" style="margin-top: 30px;">
                ...
                <tbody>';
                    ...
                    $sqlGetstudent_session = "SELECT * FROM `score` INNER JOIN students ON score.StudentID=students.id AND ClassID = '$classid' AND SectionID = '$sectionnew' AND SubjectID = '0' AND Term = '$term' AND Session = '$session' AND students.is_active = 'yes'";
