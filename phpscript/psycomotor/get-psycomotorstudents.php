            ...
            echo'<span id="displaysmg" style="font-size:14px;"><div class="alert alert-primary" role="alert">
              ...
              <table class="table table-striped table-bordered" id="editable-datatable" style="margin-top: 30px;">
                ...
                <tbody>';
                    ...
                    $sqlGetstudent_session = "SELECT * FROM `students` INNER JOIN psycomotor_score ON students.id=psycomotor_score.studentid AND psycomotor_score.session='$session' AND psycomotor_score.classid = '$classid' AND psycomotor_score.sectionid = '$sectionnew' AND psycomotor_score.term = '$term' AND students.is_active = 'yes'";
